...
Virus will have the following components:
    ...
    - Immunocompromised modifiers V.immune: Dict[str, float]:
        Infection rate modifier V.immune["infection"]: float
        Contraction rate modifier V.immune["contraction"]: float
        Recovery rate modifier V.immune["recovery"]: float
        Death rate modifier V.immune["death"]: float
